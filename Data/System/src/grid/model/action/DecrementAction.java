...
/**
 * Description: DecrementAction decrememnts by the value grid location of the
 * agent
 * 
 * @author Michael A. Kovacina
 */
public class DecrementAction extends AbstractGridAction
{
	 ...
	 * @param parameters
	 */
	public DecrementAction( Map parameters )
	{
		super( parameters );
	...
	public void initialize( AvatarModel model, Map environmentMap )
	{
		...
		decrementValue = Integer.parseInt( ( String )model.query( valueReference ) );
	}
	...
	public void invoke( AvatarModel model, Map environmentMap )
	{
		...
		gm.set( p, currentValue - decrementValue );
	}
}